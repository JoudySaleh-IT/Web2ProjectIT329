...
// Get quiz details to verify it belongs to the current educator
...
if (!$quiz) {
    die("Quiz not found or you don't have permission to edit this quiz");
}
...
<head>
  ...
  <title>Spark • Add New Question</title>
  ...
  <main class="main-content">
    ...
    <section class="card">
      ...
      <div class="card-body">
        ...
        <form id="addQuestionForm" method="POST" action="process_add_question.php" enctype="multipart/form-data">
          ...
          <div class="form-grid">
            ...
            <textarea id="question" name="question" class="control" rows="5" required placeholder="Enter your question here..."></textarea>

            <label class="label" for="figure">Optional Figure</label>
            <input type="file" id="figure" name="figure" accept="image/*" class="control" onchange="previewImage(this)" />
            ...
            <div id="imagePreviewContainer">
              ...
              <button type="button" id="removeImageBtn" class="btn btn-danger" style="display: none; margin-top: 10px;" onclick="removeSelectedImage()">
                Remove selected image
              </button>
            </div>

            <label class="label" for="ansA">Answer A</label>
            <input id="ansA" name="ansA" type="text" class="control" required placeholder="Enter answer A" />

            <label class="label" for="ansB">Answer B</label>
            <input id="ansB" name="ansB" type="text" class="control" required placeholder="Enter answer B" />

            <label class="label" for="ansC">Answer C</label>
            <input id="ansC" name="ansC" type="text" class="control" required placeholder="Enter answer C" />

            <label class="label" for="ansD">Answer D</label>
            <input id="ansD" name="ansD" type="text" class="control" required placeholder="Enter answer D" />
